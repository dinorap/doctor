...
- style_instruction: Positive style description for reference prompts
- negative_prompt: What to AVOID
- scene_prefix: Prefix for scene image prompts  
...
def get_material(material_id: str) -> dict | None:
    """Get material by ID. Returns None if not found."""
