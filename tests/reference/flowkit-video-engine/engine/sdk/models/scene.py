...
from engine.sdk.models.media import MediaAsset, OrientationSlot, GenerationResult
...
class Scene(DomainModel):
    ...
    async def execute_generate_image(
        ...
        *,
        ...
        from engine.sdk.services.operations import get_operations
        from engine.sdk.services.result_handler import parse_result, apply_scene_result
